//! The color palette: Tailwind CSS v3.4 names and values, so a class
//! reads the same here as on the web.

/// Every named color as `(name, (r, g, b))`.
...
/// The color of a palette name, `red-500`, `white`, `black`.
...
/// The palette name nearest to a color, by distance in RGB.
